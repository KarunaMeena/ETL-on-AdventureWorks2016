...
CREATE TABLE DimEmployeeSalaryHistory(
        EmployeeSalaryHistorySK int NOT NULL identity (1,1),
...
CREATE TABLE DimSalesTerritory(
	SalesTerritorySK                  int IDENTITY NOT NULL,
...
(
    ProductPurchasedSK                int IDENTITY not null, -- renamed ProductPurchasedSK  
...
CREATE TABLE DimVendors(
  VendorSK                 int IDENTITY NOT NULL,
...
CREATE TABLE DimShipMethod(
  ShipMethodSK       int IDENTITY  NOT NULL,
...
CREATE TABLE DimProductVendor(
  ProductVendorSK                   int IDENTITY NOT NULL,
...
CREATE TABLE DimPayHistory(          
  PayHistorySK        int IDENTITY  NOT NULL,
  ...
  scd_start           datetime       NULL,  -- from SOR
  scd_end             datetime       NULL,  -- from SOR
  ...
  -- SOR_UpdateDate    datetime          NULL,  -- from SOR
  DI_Job_ID           nvarchar(20)   NULL ,
  DI_Create_Date      datetime       NULL default getdate(),
  DI_Modified_Date    datetime       NULL default getdate(),
PRIMARY KEY (PayHistorySK)
);

/****** Object:  Table dbo.DimVendorContacts******/
CREATE TABLE DimVendorContacts(
        VendorContactsSK                  int IDENTITY NOT NULL,
...
CREATE TABLE FactPurchases(
     PurchaseSK              int IDENTITY NOT NULL,
...
CREATE TABLE DimLocation(
        LocationSK int IDENTITY NOT NULL,
...
CREATE TABLE DimScrapReason(
	ScrapReasonSK int IDENTITY NOT NULL,
...
(
        WorkOrderSK int IDENTITY NOT NULL,
...
(
  ResellerSK           int IDENTITY(1,1) not null,
  ...
  DI_Create_Date         datetime          NOT NULL default getdate(),
  DI_Modified_Date       datetime          NOT NULL default getdate(),
  PRIMARY KEY CLUSTERED (ResellerSK)
)
;
...
CREATE TABLE DimCurrency(
	...
	CurrencyName nvarchar(50) NOT NULL,
        ...
        DI_Create_Date                    datetime          NOT NULL default getdate(),
        DI_Modified_Date                  datetime          NOT NULL default getdate(),
PRIMARY KEY CLUSTERED (CurrencySK ASC)
)
;
...
CREATE TABLE DimPromotion(
	...
	PromotionDiscountPct float NULL,
	...
	PromotionMaxQty int NULL,
        ...
        DI_Create_Date                    datetime          NOT NULL default getdate(),
        DI_Modified_Date                  datetime          NOT NULL default getdate(),
PRIMARY KEY CLUSTERED (PromotionSK ASC)
)
;
...
CREATE TABLE FactInternetSales(
	InternetSalesSK int IDENTITY(1,1) NOT NULL,
	ProductSK int NOT NULL,
	OrderDateSK int NOT NULL,
	...
	ShipDate datetime NULL,
        ...
        DI_Create_Date                    datetime          NOT NULL default getdate(),
        DI_Modified_Date                  datetime          NOT NULL default getdate(),
PRIMARY KEY CLUSTERED (InternetSalesSK ASC)
)
;
